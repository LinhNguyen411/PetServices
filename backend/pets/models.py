...
class Weight(models.Model):
    species = models.ForeignKey(Species, on_delete=models.PROTECT, related_name="species_weight")
...
class Pet(models.Model):
    ...
    weight = models.ForeignKey(Weight, on_delete=models.PROTECT, related_name="have_weight")
